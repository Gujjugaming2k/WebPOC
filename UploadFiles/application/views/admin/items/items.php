            ...
            <table id="example" class="cell-border example" cellspacing="0" width="100%">
               <thead>
                  <tr>
                     ...
                     <th><?php if(isset($this->phrases['Fees'])) echo $this->phrases['Fees'];?></th>
					 <th><?php if(isset($this->phrases['WPrice'])) echo $this->phrases['WPrice'];?></th>
                     <th><?php if(isset($this->phrases['PER_KILL'])) echo $this->phrases['PER_KILL'];?></th>
                     <th><?php if(isset($this->phrases['Runner_Price'])) echo $this->phrases['Runner_Price'];?></th>
					 <th><?php if(isset($this->phrases['No_user'])) echo $this->phrases['No_user'];?></th>
					 <th><?php if(isset($this->phrases['Time'])) echo $this->phrases['Time'];?></th>
					 <th><?php if(isset($this->phrases['Social_Link'])) echo $this->phrases['Social_Link'];?></th>
               ...
               <tbody>
                  ...
                  <tr>
                     ...
                     <td><?php echo $item->WPrice; ?></td>
                     <td><?php echo $item->PER_KILL; ?></td>
					  <td><?php echo $item->Runner_Price; ?></td>
                     <td><?php echo $item->No_user; ?></td>
					 <?php 
$timestamp = date("F d, Y h:i:s A", strtotime($item->Time));
