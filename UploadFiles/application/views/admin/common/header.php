...
<html lang="en">
   ...
   <body>
      <div class="container-fluid paddig">
         <div class="top">
            <div class="col-md-2 paddig">
               <div class="logo">
                  <?php if(isset($site_settings->site_logo) && ($site_settings->site_logo)!= ""){?>
                  <a href="<?php echo site_url();?>"><img src="<?php echo base_url().IMG_SITE_LOGO.DS;?><?php if(isset($site_settings->site_logo)) echo $site_settings->site_logo;?>"width="240" height="65">  </a>
                  <?php }else{?>
