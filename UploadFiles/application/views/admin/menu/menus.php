            ...
            <table id="example" class="cell-border example" cellspacing="0" width="100%">
               <thead>
                  <tr>
                     ...
                     <th><?php if(isset($this->phrases['Map_name'])) echo $this->phrases['Map_name'];?></th>
					 <th><?php if(isset($this->phrases['Match_Version'])) echo $this->phrases['Match_Version'];?></th>
               ...
               <tbody>
                  ...
                  <tr>
					 ...
					 <td><?php echo $menu->Map_name; ?></td>
                     <td><?php echo $menu->Match_Version; ?></td>
