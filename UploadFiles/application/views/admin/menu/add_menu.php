         ...
         <div class="panel-body paddig">
            <div class="inner-pages-forms">
               ...
               <div class="col-md-6">
				  ...
				  <div class="form-group">
                     <label><?php if(isset($this->phrases['Map_name'])) echo $this->phrases['Map_name'];?><span style="color:red;">*</span></label>
                     <?php echo form_input('Map_name',set_value('Map_name')); ?>
                     <?php echo form_error('Map_name'); ?>
                  </div>
				  <div class="form-group">
                     <label><?php if(isset($this->phrases['Version'])) echo $this->phrases['Version'];?><span style="color:red;">*</span></label>
                     <?php echo form_input('Match_Version',set_value('Match_Version')); ?>
                     <?php echo form_error('Match_Version'); ?>
                  </div>
				  <div class="form-group">
