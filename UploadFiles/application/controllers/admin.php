	...
	*/
    ...
    function add_menu()
    {
        ...
        if ($this->input->post()) 
		{
            ...
            if ($this->form_validation->run() == TRUE) {
                ...
                $input_data['Map_name'] 	 = $this->input->post('Map_name');
                $input_data['Match_Version']   = $this->input->post('Match_Version');
    ...
    function add_item()
    {
        if ($this->input->post()) {
            ...
            $this->form_validation->set_rules('Fees', $this->phrases['item cost'], 'required|numeric|xss_clean');
            ...
            if ($this->form_validation->run() == TRUE) {
                ...
                $input_data['Fees']        = $this->input->post('Fees');
                $input_data['item_type']        = $this->input->post('item_type');
                $input_data['item_description'] = $this->input->post('description');
                $input_data['status']           = $this->input->post('status');
                $input_data['WPrice']           = $this->input->post('WPrice');
                $input_data['PER_KILL']           = $this->input->post('PER_KILL');
                $input_data['Runner_Price']           = $this->input->post('Runner_Price');
                $input_data['No_user']           = $this->input->post('No_user');
               $input_data['Time']           = $this->input->post('Time');
                $input_data['Social_Link']           = $this->input->post('Social_Link');
